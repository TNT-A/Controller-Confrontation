...
func get_direction():
	...
	if accept_input and Input.is_action_pressed("P1_Move_Up"):
		input.y -=1
	if accept_input and Input.is_action_pressed("P1_Move_Down"):
		input.y +=1
	if accept_input and Input.is_action_pressed("P1_Move_Left"):
		input.x -=1
	if accept_input and Input.is_action_pressed("P1_Move_Right"):
		input.x +=1
	return input
